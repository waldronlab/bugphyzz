...
test_that("the checkColumn function works.", {
  ...
  err1 = checkColumnValues("NCBI_ID",  dataset_with_bad_values)
  err2 = checkColumnValues("Attribute", dataset_with_bad_values)
  err3 = checkColumnValues("Attribute_value", dataset_with_bad_values)
